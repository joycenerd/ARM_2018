...
This program is to get data from input file (input.txt) and transform every lower case letter in the input data to upper case and pass the data to output file. 
...
* Processing input data from input file:
	...
	4. reading file by running a loop and using SWI_Read
		* inside my input file look like this: Hello, I'm a second year computer science student.
...
* Write my string to output file:
	1. Open output file using SWI_Open
	...
	3.  close output file by SWI_Close
		* my output file result will be like this: HELLO, I'M A SECOND YEAR COMPUTER SCIENCE STUDENT.
